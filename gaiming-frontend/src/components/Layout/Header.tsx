      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            >
              {theme.mode === 'light' && <Sun className="w-5 h-5 text-gray-600 dark:text-gray-400" />}
              {theme.mode === 'dark' && <Moon className="w-5 h-5 text-gray-600 dark:text-gray-400" />}
              {theme.mode === 'system' && <Monitor className="w-5 h-5 text-gray-600 dark:text-gray-400" />}
            </button>
                ...
                {themeOptions.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'w-full flex items-center space-x-2 px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors',
