...
Write-Host "`n[HEALTH] HEALTH CHECKS" -ForegroundColor Magenta
...
Write-Host "`n[AUTH] AUTHENTICATION" -ForegroundColor Magenta
...
Write-Host "`n[USERS] USER MANAGEMENT" -ForegroundColor Magenta
...
Write-Host "`n[GAMES] GAMES ENDPOINTS" -ForegroundColor Magenta
...
Write-Host "`n[RECS] RECOMMENDATIONS" -ForegroundColor Magenta
...
Write-Host "`n[ANALYTICS] ANALYTICS" -ForegroundColor Magenta
...
Write-Host "`n[SUMMARY] TEST RESULTS" -ForegroundColor Magenta
...
Write-Host "Working endpoints can be used immediately." -ForegroundColor White
